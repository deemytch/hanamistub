...
module Proxy
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['PROXY_SESSIONS_SECRET']
      ...
      #           Object, the parser
      #
      body_parsers :json, MsgPackParser.new, XmlParser.new
      ...
      #
      layout :application # It will load Proxy::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Proxy::Action is included
      ...
      # Configure the code that will yield each time Proxy::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include Proxy::Assets::Helpers
      end
    end
